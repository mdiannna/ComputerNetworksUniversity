...
class waitForConfirmation(threading.Thread):
    ...
    def run(self):
        while True:
            global currentConfirmationWait 
            # currentConfirmationWait = currentConfirmationWait+1
            number = 0;
            ...
            try:
               ...
               # threadLock.acquire()
                ...
                # while (window_start in confirmedNumbers and window_end < max_number):
                #     window_end = window_end + 1
                #     window_start = window_start + 1

                while(window_end < max_number and number == window_start):
                        window_start = window_start+1;
                        window_end = window_end+1;

                        # if(not number in confirmedNumbers):
